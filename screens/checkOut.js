...
export default class BarcodeScannerExample extends React.Component {
  ...
  clearData = () => {
    let collection = {};
    collection.qrCode = this.state.qrCode;
    let url = 'http://ec2-54-207-107-89.sa-east-1.compute.amazonaws.com:3000/postgresql/checkOut';
    ...
    .catch(error => {
		...
		alert(`Erro ao fazer o check out, tentar novamente`);
	})
    .then(response => {
